...
return [
    ...
    'stores' => [
        ...
        'database' => ['driver' => 'database', 'connection' => env('DB_CONNECTION'), 'table' => env('DB_CACHE_TABLE', 'cache'), 'lock_table' => env('DB_CACHE_LOCK_TABLE', 'cache_locks')],
    ...
    'prefix' => env('CACHE_PREFIX', 'venuesync_cache'),
];